...
class MahasiswaResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'urlKtm' => $this->url_ktm,
            'url_ktm' => $this->url_ktm,
            'urlTranskripNilai' => $this->url_transkrip_nilai,
            'url_transkrip_nilai' => $this->url_transkrip_nilai,
            'urlBuktiLulusMetopen' => $this->url_bukti_lulus_metopen,
            'url_bukti_lulus_metopen' => $this->url_bukti_lulus_metopen,
            'urlSertifikatBta' => $this->url_sertifikat_bta,
            'url_sertifikat_bta' => $this->url_sertifikat_bta,
            'userId' => $this->user_id,
