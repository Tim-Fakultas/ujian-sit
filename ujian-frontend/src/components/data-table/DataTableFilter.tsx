...
import { Search as SearchIcon, Settings2, Check, Calendar as CalendarIcon, FileDown } from "lucide-react";
...
export function DataTableFilter({
    ...
    return (
        <div className={cn("flex items-center gap-2 mb-4 w-full md:justify-end", className)}>
                        ...
                        <PopoverTrigger asChild>
                            <Button
                                ...
                                className={cn(
                                    ...
                                    hasActiveFilters && "bg-blue-50 text-blue-600 border-blue-200 dark:bg-blue-900/20 dark:text-blue-400 dark:border-blue-800"
                                )}
                            >
                                <Settings2 size={16} />
                            </Button>
                                        ...
                                        {group.options.map((opt) => (
                                            <Button
                                                ...
                                                className={cn(
                                                    ...
                                                    group.value === opt.value ? "bg-accent text-accent-foreground font-medium" : ""
                                                )}
                                                onClick={() => {
