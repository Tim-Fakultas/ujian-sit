...
interface RejectedRanpel extends RancanganPenelitian {
    mahasiswa?: {
        nama: string;
        nim: string;
        angkatan: string;
...
export default function JudulDitolakTable({ data }: { data: RejectedRanpel[] }) {
        ...
        <DataCard>
            ...
            <div className="mt-4">
                <TableGlobal
                    table={table}
                    cols={cols}
                    emptyMessage="Tidak ada data judul yang ditolak."
                />
            </div>
        </DataCard>
    );
