                ...
                <Card className="w-full">
                    ...
                    >
                        <DialogContent className="max-w-2xl">
                            <DialogHeader>
                                <DialogTitle>Detail Judul Skripsi</DialogTitle>
                                <DialogDescription>
                                    Informasi lengkap judul skripsi yang diterima
                                </DialogDescription>
                            </DialogHeader>
                            {selectedItem && (
                                <div className="space-y-4">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="md:col-span-2">
                                            ...
                                            <p className="mt-1 font-medium">{selectedItem.judul}</p>
                                        </div>
                                        <div>
                                            <label className="text-sm font-medium text-muted-foreground">
                                                Dosen Pembimbing
                                            </label>
                                            <p className="mt-1">{selectedItem.dosen_pembimbing}</p>
                                        </div>
                                        <div>
                                            <label className="text-sm font-medium text-muted-foreground">
                                                Status
