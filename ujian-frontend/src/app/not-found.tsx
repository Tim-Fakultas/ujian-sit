...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center p-4 bg-gray-50 dark:bg-neutral-950 relative overflow-hidden font-sans selection:bg-blue-100 selection:text-blue-900">
      {/* Background Elements */}
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-lg mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto animate-in fade-in slide-in-from-bottom-5 duration-700 delay-300">
          ...
          <Button
            asChild
            className="gap-2 h-11 px-6 bg-blue-600 hover:bg-blue-700 text-white shadow-lg shadow-blue-600/20 dark:shadow-blue-900/40 border-0 rounded-xl"
          >
            <Link href="/">
              <Home size={16} />
              Ke Beranda
