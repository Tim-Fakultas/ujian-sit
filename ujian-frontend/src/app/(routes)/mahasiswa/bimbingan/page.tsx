...
import { Upload, Plus, FileText, Search } from "lucide-react";
  ...
  return (
    <div className="min-h-screen p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Pengajuan bimbingan Proposal/Skripsi dengan dosen pembimbing
            </p>
          </div>
            ...
            <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto rounded">
              ...
              <form className="space-y-4">
                ...
                <div>
                  ...
                  <Input placeholder="Masukkan judul" className="rounded" />
                </div>

                <div>
                  <label className="text-sm font-medium">Upload File</label>
                  <div className="flex items-center gap-2">
                    <Input type="file" className="bg-white rounded" />
                    <Button
                      type="button"
                      variant="outline"
                      size="sm"
                ...
                <DialogFooter>
                  <Button className="rounded">Simpan</Button>
                </DialogFooter>
              </form>
            </DialogContent>
          </Dialog>
        ...
        {/* Alert */}
        <Alert className="mb-6 bg-yellow-50 border-yellow-300 rounded">
          <AlertTitle className="font-semibold text-yellow-800">
            Peringatan!
          </AlertTitle>
          <AlertDescription className="text-yellow-700">
            Mahasiswa wajib mengambil Mata Kuliah (Proposal/Skripsi) yang akan
            dibimbingkan.
          </AlertDescription>
        </Alert>
            ...
            {selected && (
              <>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Informasi lengkap bimbingan mahasiswa.
                  </DialogDescription>
                </DialogHeader>
