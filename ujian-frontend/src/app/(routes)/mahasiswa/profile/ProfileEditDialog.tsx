...
export function ProfileEditDialog({ user }: ProfileEditDialogProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await updateMahasiswaProfileAction({
                ...
                peminatan_id: formData.peminatan_id ? parseInt(formData.peminatan_id) : undefined,
    ...
    return (
        <Dialog open={open} onOpenChange={handleDialogChange}>
            ...
            <DialogContent className="max-w-[90%] sm:max-w-[50%] rounded-xl max-h-[90vh] p-0 gap-0 overflow-hidden" showCloseButton={false}>
                {/* Fixed Header */}
                ...
                <div className="overflow-y-auto max-h-[calc(90vh-180px)]">
                    <form onSubmit={handleSubmit} className="space-y-6 px-6 py-4" id="profile-edit-form">
                        {/* Informasi Data Diri */}
                        <div className="space-y-4">
                            <h4 className="text-sm font-medium leading-none border-b pb-2 text-muted-foreground">Informasi Pribadi</h4>
                        ...
                        <div className="space-y-4">
                            <h4 className="text-sm font-medium leading-none border-b pb-2 text-muted-foreground">Data Akademik</h4>
                        ...
                        {/* Dokumen Kelengkapan */}
                        <div className="space-y-4">
                            <h4 className="text-sm font-medium leading-none border-b pb-2 text-muted-foreground">Dokumen Kelengkapan</h4>
                            <div className="space-y-4">
                                <FileUploadCard
                ...
                <div className="sticky bottom-1 z-10 bg-background border-t px-6 py-4">
                    <div className="flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
                        ...
                        <Button type="submit" form="profile-edit-form" disabled={isLoading} className="gap-2">
                            {isLoading ? (
