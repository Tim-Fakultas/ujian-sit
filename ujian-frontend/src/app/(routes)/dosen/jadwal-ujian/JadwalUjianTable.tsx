...
export default function JadwalUjianTable({
  ...
  // Ganti state refresh
  // const [refreshHadir, setRefreshHadir] = useState(false);
  ...
  return (
    <div className="bg-white p-6 rounded-2xl shadow-lg border dark:bg-neutral-900">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        {/* Search bar & filter (right) */}
        <div className="flex w-full gap-3 md:justify-end md:ml-auto">
          <div className="relative w-full max-w-xs">
            <Input
              placeholder="Cari mahasiswa, judul, ruangan..."
              value={search}
          ...
          <Popover>
            ...
            <PopoverContent
              align="end"
              className="min-w-[220px] p-3 rounded-xl border border-muted shadow-lg bg-white dark:bg-neutral-900"
            >
      ...
      >
        <TabsContent value="table">
          <div className="border overflow-auto rounded-xl shadow-sm">
            <Table>
                    ...
                    return (
                      ...
                      {ujian.ruangan?.namaRuangan ?? "-"}
                        ...
                        <TableCell className="text-center">
                                        ...
                                        <div>
                                          ...
                                          <div className="mt-1 text-sm flex flex-col gap-1">
                                            ...
                                            <div className="inline-flex items-center gap-2">
                                              <Clock size={14} />
                                              <span>
                                                {ujian.waktuMulai?.slice(
                                                  0,
                                                  5
                                                ) ?? "-"}{" "}
                                                -{" "}
                                                {ujian.waktuSelesai?.slice(
                                                  0,
                                                  5
                                                ) ?? "-"}
                                              </span>
                          ...
                          <CatatanSheet
                            openCatatan={openCatatan}
                            setOpenCatatan={setOpenCatatan}
                            selected={selected}
                            ujian={ujian}
                          ...
                          <KeputusanSheet
                            openKeputusan={openKeputusan}
                            setOpenKeputusan={setOpenKeputusan}
                            selected={selected}
                            ujian={ujian}
                            keputusanOptions={keputusanOptions}
                            keputusanChoice={keputusanChoice}
                            setKeputusanChoice={setKeputusanChoice}
            ...
            {filteredData.length === 0 ? (
              ...
              filteredData.map((ujian, idx) => {
                ...
                return (
                  <div
                    key={ujian.id}
                    className="border rounded-xl p-5 bg-white dark:bg-neutral-900 shadow-lg flex flex-col gap-2 hover:shadow-xl transition-shadow"
                  >
                    ...
                    <div className="mb-1">
                      ...
                      <div className="whitespace-pre-line break-words text-sm mt-1">
                        {ujian.judulPenelitian}
                      </div>
                    </div>
